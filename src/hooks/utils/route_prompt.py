...
ROUTES = [
    ...
    (
        ...
        "(the accounting SaaS, bank exports); never infer them from stale context.",
        r"\b(factura|facturas|trimestre|iva\b|irpf|the accounting SaaS|movimientos|"
    ...
    (
        ...
        r"\b(recap|resumen)\b.{0,40}\b(discord|slack|alex|sam)\b",
    ),
    (
        "lovable-sync",
        ...
        r"lovable a (esta app|la app|consumer-o)\b)",
    ),
    (
        "debug",
    ...
    (
        ...
        r"((conectate|conéctate|conecta) .{0,20}(ssh|server-a\.|servidor)|"
        ...
        r"\bvps\b|desbloquea\w* .{0,30}(ip|server-a\.))",
    ),
    (
        "release",
